...
public class ControllingActivity extends Activity {
    ...
    final static String pokreni = "88";
    final static String zaustavi = "22";


    private ProgressDialog progressDialog;
    Button btnOn, btnOff;
    Button btnMuzika, btnStop;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnMuzika =(Button)findViewById(R.id.muzika);
...
// TODO Auto-generated method stub
                ...
                try {
                    mBTSocket.getOutputStream().write(zaustavi.getBytes());
...
// TODO Auto-generated method stub
    ...
    private class ConnectBT extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            progressDialog = ProgressDialog.show(ControllingActivity.this, "Hold on", "Connecting");// http://stackoverflow.com/a/11130220/1287554
